...
export default function BreadcrumbPageDoc() {
  return (
    ...
    >
      <Section title="Usage" description="A basic breadcrumb structure.">
        <ComponentPreview
          code={`<Breadcrumb>
  <BreadcrumbList>
    <BreadcrumbItem>
    ...
    <BreadcrumbItem>
      ...
      <Section title="Custom Separator" description="Use a custom icon or text as a separator.">
        <ComponentPreview
          code={`<Breadcrumb>
  <BreadcrumbList>
    <BreadcrumbItem>
    ...
    <BreadcrumbItem>
      ...
      <Section title="Collapsed" description="Use the ellipsis to indicate hidden items.">
        <ComponentPreview
          code={`<Breadcrumb>
  <BreadcrumbList>
    <BreadcrumbItem>
